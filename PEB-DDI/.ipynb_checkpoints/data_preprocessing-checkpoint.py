...
fp = np.load('morgan_drugbank.npz')
fp = fp['features']
...
class DrugDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        pos_tri = (pos_h_samples, pos_t_samples, pos_rels, pos_b_samples, pos_h_fp,pos_t_fp, pos_h_edge_samples, pos_t_edge_samples)
        ...
        neg_tri = (neg_h_samples, neg_t_samples, neg_rels, neg_b_samples, neg_h_fp,neg_t_fp, neg_h_edge_samples, neg_t_edge_samples)
