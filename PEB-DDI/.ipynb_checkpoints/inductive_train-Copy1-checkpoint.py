...
#定义要优化的参数
space = {
    'k_dim': hp.choice('k_dim', range(64, 257)),
    'e_dim': hp.choice('e_dim', range(64, 257)),
    'dp': hp.uniform('dp', 0, 1)
    #...添加其他需要优化的参数...
}

#定义优化目标函数
def objective(params):
    model = models_i_drop.MVN_DDI([55, 2048, 200], 17, params['k_dim'], params['k_dim'], 86, [64,64,64,64], [2, 2, 2, 2], params['e_dim'], params['dp'])
