...
# model = models.MVN_DDI([n_atom_feats, 2048, 200], 17, kge_dim, kge_dim, rel_total, heads_out_feat_params=[32,32,32,32], blocks_params=[4, 4, 4, 4])
# model = models.MVN_DDI([n_atom_feats, 2048, 200], 17, kge_dim, kge_dim, rel_total, heads_out_feat_params=[128,128,128,128], blocks_params=[1, 1, 1, 1])
...
# model = models_i.MVN_DDI([n_atom_feats, 2048, 200], 17, kge_dim, kge_dim, rel_total, heads_out_feat_params=[64,64], blocks_params=[2, 2])

# model = models_drop.MVN_DDI([n_atom_feats, 2048, 200], 17, kge_dim, kge_dim, rel_total, heads_out_feat_params=[64,64], blocks_params=[2, 2])
