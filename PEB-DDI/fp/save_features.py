...
class Args(Tap):
    data_path: str='./data/drug_list_drugbank.csv'  # Path to data CSV
    ...
    save_path: str='./features/morgan_drugbank.npz'  # Path to .npz file where features will be saved as a compressed numpy archive
